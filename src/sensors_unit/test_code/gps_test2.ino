...
/*
   ...
   Modified for Arduino Due: Uses Hardware Serial1 instead of SoftwareSerial.
   Connect GPS TX to Due Pin 19 (RX1).
*/
...
// Use Hardware Serial1 on the Arduino Due (RX1=19, TX1=18)
...
void setup()
{
  ...
  Serial.println(F("SatelliteTracker.ino (Arduino Due Version)"));
