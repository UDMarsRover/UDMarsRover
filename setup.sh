...
#sudo aptitude install llibcamera0.6
...
echo "########################################################"
echo "--- Setting up OpenTera Docker Environment ---"

# Create the folder and navigate into it
sudo mkdir -p /home/udmrt/opentera-docker
cd /home/udmrt/opentera-docker

echo "Creating Dockerfile..."

# Use EOF wrapped in quotes 'EOF' to prevent local shell expansion inside the Dockerfile
sudo bash -c 'cat << "EOF" > Dockerfile
# Use an official Ubuntu or Debian base image (adjust as needed for OpenTera)
FROM ubuntu:22.04
...
# (Optional) Add your OpenTera specific setup commands here
# COPY . .
# RUN ...
...
# Ensure the udmrt user owns the directory files for easier editing later
sudo chown -R udmrt:udmrt /home/udmrt/opentera-docker

echo "--- OpenTera Docker setup complete! ---"
echo "Dockerfile created at: /home/udmrt/opentera-docker/Dockerfile"
